...
while round_count < configs["MAX_ROUNDS"]:
    ...
    status, rsp, token_usage = mllm.get_model_response(prompt, [base64_img_before])
    ...
    status, rsp, token_usage = mllm.get_model_response(prompt, [base64_img_before, base64_img_after])
    if status:
